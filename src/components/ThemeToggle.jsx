export default function ThemeToggle({className=""}) {
  const toggle = () => {
    ...
    // ajuda controles nativos a seguirem o tema
  ...
  return (
    <button
      ...
      type="button"
    >
      {/* ícone sol/lua simples */}
      <svg className="h-5 w-5 dark:hidden" viewBox="0 0 24 24" fill="currentColor"><path d="M6.76 4.84l-1.8-1.79L3.17 4.84l1.79 1.8 1.8-1.8zm10.48 0l1.79-1.79 1.79 1.79-1.79 1.8-1.79-1.8zM12 4V1h0v3h0zm0 19v-3h0v3h0zM4 13H1v-2h3v2zm22 0h-3v-2h3v2zM6.76 19.16l-1.8 1.79-1.79-1.79 1.79-1.8 1.8 1.8zM19.24 19.16l1.79 1.79 1.79-1.79-1.79-1.8-1.79 1.8zM12 7a5 5 0 100 10 5 5 0 000-10z"/></svg>
