...
import foto from "../assets/../assets/c9a42c1f307ce900533cf3aed2933eba_0.jpeg";
  ...
  return (
    <section className="relative overflow-hidden" aria-label="Apresentação pessoal">
      ...
      <div className="section py-20 sm:py-28 relative" id="conteudo">
        <div className="grid gap-8 sm:grid-cols-[1fr,auto] sm:items-center">
          <div>
          ...
          <figure className="justify-self-center sm:justify-self-end text-center">
            <div className="pfp-frame">
              <img src={foto} alt="Gabrielle Calazans Zollner" className="pfp-img" />
            </div>
            <figcaption className="mt-2 text-xs text-black/60 dark:text-white/60">Foto de perfil</figcaption>
          </figure>
        </div>
      </div>
    </section>
